...
procedure RQ__ParseURLGotString(data:Pointer; var uin, flags:integer; var when:TDateTime; var URL, text:string);
...
procedure RQ__ParseAuthRequestGotString(data:Pointer; var uin, flags:integer; var when:TDateTime; var text:string);
procedure RQ__ParseAuthDeniedSentString(data:Pointer; var uin:integer; var text:string);
procedure RQ__ParseAutoMessageSentString(data:Pointer; var uin:integer; var text:string);
procedure RQ__ParseAutoMessageGotString(data:Pointer; var uin:integer; var text:string);
...
var
 data: Pointer;
begin
 data := CallStr(char(PM_GET)+char(PG_RNQ_BUILD));
 Result := _int_at(data,5)
end;
